...
const HUD_AVATAR_FRAME_SRC = '/assets/ui/small-icon-frame.svg';
const HUD_AVATAR_MASK_SRC = '/assets/ui/avatar-frame-mask.svg';
const HUD_BUTTON_S_FRAME_SRC = '/assets/ui/menu-button-small-frame.svg';
